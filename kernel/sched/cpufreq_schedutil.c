...
static int sugov_init(struct cpufreq_policy *policy)
{
	...
	default:
	case 0:
		tunables->rate_limit_us = CONFIG_SCHEDUTIL_LP_RATE_LIMIT;
		...
		break;
	case 4:
		tunables->rate_limit_us = CONFIG_SCHEDUTIL_PERF_RATE_LIMIT;
		...
		break;
	case 7:
		tunables->rate_limit_us = CONFIG_SCHEDUTIL_PRIME_RATE_LIMIT;
